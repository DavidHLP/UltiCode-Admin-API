...
CREATE TABLE `test_cases_outputs` (
  ...
  `out_type` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '输出类型',
...
) ENGINE=InnoDB AUTO_INCREMENT=1954567456779739138 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

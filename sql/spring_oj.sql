...
CREATE TABLE `problems` (
  ...
  `input_format` text COLLATE utf8mb4_general_ci COMMENT '输入格式说明',
  `output_format` text COLLATE utf8mb4_general_ci COMMENT '输出格式说明',
  `sample_input` text COLLATE utf8mb4_general_ci COMMENT '样例输入',
  `sample_output` text COLLATE utf8mb4_general_ci COMMENT '样例输出',
  `hint` text COLLATE utf8mb4_general_ci COMMENT '题目提示',
...
CREATE TABLE `test_cases` (
  ...
  `input_file` varchar(255) COLLATE utf8mb4_general_ci NOT NULL COMMENT '输入文件的路径或标识',
  `output_file` varchar(255) COLLATE utf8mb4_general_ci NOT NULL COMMENT '期望的输出文件的路径或标识',

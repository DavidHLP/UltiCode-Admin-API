...
public class ContestAdminController {
        ...
        public ApiResponse<PageResult<ContestSummaryView>> listContests(
                        ...
                        @RequestParam(defaultValue = "10") @Min(value = 1, message = "分页大小不能小于1") @Max(value = 100, message = "分页大小不能超过100") int size,
                ...
                log.info(
                                ...
                                startFrom,
                                endTo);
                PageResult<ContestSummaryView> result = contestPlanningService.listContests(
        ...
        public ApiResponse<List<ContestParticipantView>> addParticipants(
                ...
                log.info(
                                ...
                                operator != null ? operator.id() : null);
                List<ContestParticipantView> participants = contestPlanningService.addParticipants(
        ...
        public ApiResponse<PageResult<ContestRegistrationView>> listRegistrations(
                        @PathVariable Long contestId,
                        @RequestParam(defaultValue = "1") @Min(value = 1, message = "页码不能小于1") int page,
                        @RequestParam(defaultValue = "20") @Min(value = 1, message = "分页大小不能小于1") @Max(value = 200, message = "分页大小不能超过200") int size,
                        @RequestParam(required = false) String status) {
                ...
                log.info(
                                ...
                                size,
                                status);
                PageResult<ContestRegistrationView> result = contestPlanningService.listRegistrations(contestId,
        ...
        public ApiResponse<ContestRegistrationView> createRegistration(
                        ...
                        @CurrentForwardedUser ForwardedUser operator) {
                ContestRegistrationCreateRequest sanitized = new ContestRegistrationCreateRequest(
                                request.userId(),
                                request.source() != null
                                                ? request.source()
                ...
                log.info(
                                ...
                                sanitized.userId(),
                                operator != null ? operator.id() : null);
                ContestRegistrationView view = contestPlanningService.createRegistration(
        ...
        public ApiResponse<List<ContestRegistrationView>> decideRegistrations(
                ...
                log.info(
                                ...
                                operator != null ? operator.id() : null);
                List<ContestRegistrationView> result = contestPlanningService.decideRegistrations(
                                contestId, request, operator != null ? operator.id() : null);
                return ApiResponse.success(result);
        }

  ...
  <div class="solution-edit">
    ...
    <el-form :model="form" ref="formRef" :rules="rules" class="solution-form">
      ...
      <el-form-item prop="language">
        <el-select v-model="form.language" placeholder="请选择编程语言" class="language-select">
      ...
      <el-form-item prop="content" class="editor-item">
        <MdEditor v-model="form.content" :preview="false" class="markdown-editor" />
      </el-form-item>
...
const rules: FormRules = {
  ...
  status: [{ required: true, message: '请选择题解状态', trigger: 'change' }],
}
...
const handleSubmit = async () => {
  ...
  try {
    ...
    if (isEdit.value && form.id) {
      // 调用更新题解的 API（后端 PUT /api/problems/view/solution，需要携带 id）

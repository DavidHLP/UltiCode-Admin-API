...
public class AuthServiceImp implements AuthService {
    ...
    private static final String LOCK_KEY_DISTRIBUTED_LOCK_PREFIX = "springoj:auth:verification:code:";
    ...
    private final RedisTemplate<String, Object> redisUtils;
    ...
    public Token login(String email, String password) {
        ...
        // 使用分布式锁防止并发重复写入
        redisUtils.lock().executeWithLock(LOCK_KEY_LOGIN_PREFIX + email, () -> tokenMapper.insert(token), 5, 30, TimeUnit.SECONDS);
        return token;
    }
    ...
    public void sendVerificationCode(String email) {
        ...
        redisUtils.lock().executeWithLock(LOCK_KEY_DISTRIBUTED_LOCK_PREFIX + email, () -> redisUtils.string().set(codeKey, code, Duration.ofMinutes(5)), 5, 30, TimeUnit.SECONDS);
    ...
    public void register(String username, String password, String email, String code) {
        ...
        // 使用分布式锁防止并发重复注册
        redisUtils.lock().executeWithLock(LOCK_KEY_REGISTER_PREFIX + email, () -> {

...
public class RedisCommonsProperties {
    ...
    /** 全局键前缀 */
    @NotBlank private String keyPrefix = "springoj:";

    /** 序列化配置 */
    @Valid @NotNull private SerializationConfig serialization = new SerializationConfig();

    /** 缓存配置 */
    @Valid @NotNull private CacheConfig cache = new CacheConfig();

    /** 锁配置 */
    @Valid @NotNull private LockConfig lock = new LockConfig();

    /** 防护配置 */
    @Valid @NotNull private ProtectionConfig protection = new ProtectionConfig();

    /** 监控配置 */
    @Valid @NotNull private MonitoringConfig monitoring = new MonitoringConfig();

    /** 序列化配置 */
    @Data
    public static class SerializationConfig {
        /** 默认序列化类型 */
        @NotNull private SerializationType defaultType = SerializationType.JSON;

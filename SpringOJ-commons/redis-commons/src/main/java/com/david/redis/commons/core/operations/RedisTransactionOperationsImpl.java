 ...
 * @author David
 */
public class RedisTransactionOperationsImpl extends AbstractRedisOperations
        implements RedisTransactionOperations {

    public RedisTransactionOperationsImpl(
                                    ...
                                    try {
                                        ...
                                        if (execResults == null) {
                                            logUtils.business()
                                                    .trace(
                                                            "redis_transaction",
                                                            "watch_key_modified",
                                                            "Redis transaction was discarded (WATCH key was modified)");
                                        ...
                                        logUtils.exception()
                                                .business(
                                                        ...
                                                        e,
                                                        "Error in Redis transaction, discarding");
                                        // 发生异常时，事务会自动被丢弃
                                        operations.discard();
                                        throw new RedisOperationException(
                                                "Redis事务执行失败", e, "TRANSACTION");
                                    }
                                }
                            });
                });

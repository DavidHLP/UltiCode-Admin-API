...
@ConditionalOnProperty(
        prefix = "spring.data.redis.commons",
        name = "enabled",
        havingValue = "true",
        matchIfMissing = true)
...
public class RedisCommonsAutoConfiguration {
    ...
    @ConditionalOnProperty(
            prefix = "spring.data.redis.commons.transaction",
            name = "enabled",
            havingValue = "true",
            matchIfMissing = true)
    ...
    public TransactionAspect transactionAspect(
        ...
        return new TransactionAspect(
                transactionManager, redisUtils, cacheKeyGenerator, metricsCollector, this.logUtils);
    }
    ...
    @ConditionalOnBean({
        RedisUtils.class,
        CacheKeyGenerator.class,
        CacheConditionEvaluator.class,
        BatchOperationManager.class,
        CacheWarmUpManager.class,
        CacheMetricsCollector.class
    })

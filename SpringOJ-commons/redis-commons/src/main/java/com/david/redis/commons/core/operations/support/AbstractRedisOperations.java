...
public abstract class AbstractRedisOperations {
     ...
     */
    protected AbstractRedisOperations(RedisTemplate<String, Object> redisTemplate,
     ...
     * @return 操作结果
     */
    protected final <T> T executeOperation(String operation, String key, Object[] params, Supplier<T> action) {
     ...
     * @param action    要执行的操作
     */
    protected final void executeOperation(String operation, String key, Object[] params, Runnable action) {
        OperationContext context = OperationContext.of(operation, key, params, transactionManager);
        executor.execute(context, action);
    }

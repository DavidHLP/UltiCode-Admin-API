...
public class AuthGlobalFilter implements GlobalFilter, Ordered {
                ...
                return Mono.fromCallable(
                                ...
                                .flatMap(
                                                authUser -> {
                                                        ...
                                                        // 记录认证成功
                                                        Map<String, Object> userContext = getUserContext(authUser,
                                                                        requestContext);

                                                        LogUtils.business()
                                                                        .auto()
                                                                        .message(String.format("身份验证成功：方法 %s，路径 %s",
                                                                                        method, path))
                                                                        .info();
                                                        ...
                                                        String roleName = authUser.getRole() != null
        ...
        private Mono<Void> handleUnauthorized(ServerHttpResponse response, String message) {
                ...
                String responseJson = String.valueOf(ResponseResult.fail(ResponseCode.RC401.getCode(), message));
